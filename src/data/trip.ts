...
export const HIGHLIGHTS: Highlight[] = [
  ...
  },
  {
    day: 1,
    kind: 'kavárna',
    name: 'Stadtbäckerei Radstadt',
    where: 'Radstadt · Hoheneggstraße 17',
    dist: 0,
    blurb:
      'Rodinná pekárna s vlastní kavárnou na rohu od Hauptplatzu. Domácí croissanty, kornouty s tvarohem, čerstvá káva už od sedmé. Otevřeno i o svátku — ideální brzké posnídáno před startem.',
    tip: 'Otevřeno už v 7:00 i o svátku. Káva + Topfengolatsche cca € 5.',
    mapsQuery: 'Stadtbäckerei Radstadt Hoheneggstraße',
    website: 'https://stadtbaeckerei.at/',
    photos: [
      'https://stadtbaeckerei.at/wp-content/uploads/2022/07/1B9A5493-1030x687.jpg',
      'https://stadtbaeckerei.at/wp-content/uploads/2022/07/1B9A5490-1030x687.jpg',
      'https://stadtbaeckerei.at/wp-content/uploads/2022/07/1B9A5476-1030x687.jpg',
    ],
    hours: 'Pá 1.5. (st. svátek): 7:00–10:00',
    rating: { stars: 4.5, count: 150, source: 'Google' },
  },
  {
    day: 1,
    kind: 'gastro',
    name: "s'Wirtshaus Gröbming",
    where: 'Gröbming · Hauptstraße',
    dist: 42,
    blurb:
      'Tradiční štýrský Wirtshaus rodiny Aigner přímo v centru Gröbmingu. Domácí kuchyně s regionálními surovinami, sluneční terasa, denní polední menu.',
    tip: 'Polední menu cca € 13–16. Vhodná svačinová zastávka před tahem k Liezenu.',
    mapsQuery: "s'Wirtshaus Gröbming",
    website: 'https://www.wirtshaus-groebming.at/',
    photos: [
      'https://images.squarespace-cdn.com/content/v1/6606ca60b35db16e3c7f4acd/1718705190510-P21SFLR4IVWC23WZOEXH/s%27wirtshaus-groebming%C2%A9DS-4.jpg',
      'https://images.squarespace-cdn.com/content/v1/6606ca60b35db16e3c7f4acd/1718705191194-7BBIUI6R60H8YCAUNE4O/s%27wirtshaus-groebming%C2%A9DS-6.jpg',
      'https://images.squarespace-cdn.com/content/v1/6606ca60b35db16e3c7f4acd/ad7bd588-1f8c-431b-a002-f6936e6d4be0/s%27wirtshaus-groebming%C2%A9DS-76.jpg',
    ],
    hours: 'Pá 1.5. (st. svátek): obvykle 11:30–22 · ověřit',
    rating: { stars: 4.4, count: 200, source: 'Google' },
  },
  {
    day: 1,
    kind: 'gastro',
    name: 'Hotel-Restaurant-Café Schnuderl',
    where: 'Liezen · Ausseer Straße 33',
    dist: 77,
    blurb:
      'Velký rodinný hotel-restaurant s celodenní kuchyní, slunečnou terasou a domácí zmrzlinou. Otevřeno denně 7–22, teplá kuchyně 11:30–21. Náhrada za uzavřený Goldener Hirsch.',
    tip: 'Domácí zmrzlina, terasa. Otevřeno celodenně i o svátku.',
    mapsQuery: 'Hotel Schnuderl Liezen Ausseer Straße',
    website: 'https://www.hotel-restaurant-schnuderl.at/',
    hours: 'Pá 1.5.: 7:00–22:00 (kuchyně 11:30–21:00)',
    rating: { stars: 4.2, count: 280, source: 'Google' },
  },
  ...
  },
  {
    day: 2,
    kind: 'kultura',
    name: 'Weidendom — vstupní centrum NP Gesäuse',
    where: 'Gstatterboden · u řeky',
    dist: 110,
    blurb:
      'Hlavní infocentrum Národního parku Gesäuse přímo na trase Ennsradwegu. Stálá výstava o Planspitze, terasa s výhledem na vápencové stěny, hřiště a možnost občerstvení.',
    tip: 'Otevřeno víkendy v květnu 10–18. Volný vstup. Bezpečné parkování kol.',
    mapsQuery: 'Weidendom Gstatterboden Nationalpark Gesäuse',
    website: 'https://nationalpark-gesaeuse.at/nationalpark-erleben/besucherzentren/',
    hours: 'So 2.5.: 10–18',
    rating: { stars: 4.5, count: 600, source: 'Google' },
  },
  {
    day: 2,
    kind: 'gastro',
    name: 'Gasthof Postwirt Großreifling',
    where: 'Großreifling (Landl) · ve starém posthofu',
    dist: 134,
    blurb:
      'Tradiční štýrský posthof s historickou klenbou a velkou zahradou. Lokální kuchyně, polední menu, dobrá zastávka mezi Hieflau a Altenmarktem.',
    tip: 'Sobota: kuchyně do 22. Sluneční zahrada za hezkého počasí.',
    mapsQuery: 'Gasthof Postwirt Großreifling',
    hours: 'So 2.5.: 10–22',
    rating: { stars: 4.3, count: 80, source: 'Google' },
  },
  {
    day: 2,
    kind: 'historie',
    name: 'Erlebniswelt Mendlingtal',
    where: 'Lassing · ~5 km odbočka u Großreifling',
    dist: 145,
    blurb:
      'Jedna z posledních fungujících vodních pil a vorařských štol střední Evropy. Sezóna otvírá právě 1.5.2026. Stezka kolem mlýnů a kanálů, dřevařské muzeum.',
    tip: 'Sezóna 1.5.–31.10. Vstup ~€ 12. Sidetrip 5 km z trasy.',
    mapsQuery: 'Erlebniswelt Mendlingtal Lassing',
    website: 'https://erlebniswelt-mendlingtal.at/',
    photos: [
      'https://erlebniswelt-mendlingtal.at/inhalte/uploads/2017/04/20150803_mendlingtal_20150803_051-500x500.jpg',
      'https://erlebniswelt-mendlingtal.at/inhalte/uploads/2017/03/20151003_113_mendlingtal-goestling-2-500x500.jpg',
      'https://erlebniswelt-mendlingtal.at/inhalte/uploads/2017/04/mendlingtal_sehenswertes_002-500x500.jpg',
    ],
    hours: 'So 2.5.: 9–17 (sezona startuje právě 1.5.)',
    rating: { stars: 4.6, count: 400, source: 'Google' },
  },
  ...
  },
  {
    day: 3,
    kind: 'kavárna',
    name: 'Cafe Frau Franzi',
    where: 'Steyr · Stadtplatz',
    dist: 214,
    blurb:
      'Brunch kavárna přímo na Stadtplatzu. Vegan-friendly snídaně, domácí limonády, otevřená v neděli — jedna z mála na náměstí.',
    tip: 'V neděli plno na brunchi, ráno přijít před 11.',
    mapsQuery: 'Cafe Frau Franzi Steyr Stadtplatz',
    website: 'https://www.fraufranzi.at/',
    photos: [
      'https://images.squarespace-cdn.com/content/v1/640b390b718943668d3a535b/220ed4e7-d226-4639-9f8b-9cde1eaeda75/fraufranzi-open-%28c%29hannesecker-0121.jpg',
      'https://images.squarespace-cdn.com/content/v1/640b390b718943668d3a535b/1eeeefef-5f49-4254-a3d5-804c26e72bd4/fraufranzi-open-%28c%29hannesecker-0039.jpg',
      'https://images.squarespace-cdn.com/content/v1/640b390b718943668d3a535b/1699004634814-AX2QZTRFLF94FEK0W8HI/fraufranzi-open-%28c%29hannesecker-0015.jpg',
    ],
    hours: 'Ne 3.5.: 9–17',
    rating: { stars: 4.5, count: 278, source: 'Google' },
  },
  {
    day: 3,
    kind: 'kavárna',
    name: 'Buburuza Eis',
    where: 'Steyr · Enge Gasse',
    dist: 214,
    blurb:
      'Top hodnocená zmrzlina ve Steyru — ručně vyráběná bez aditiv. Sezónní příchutě, často fronty. Perfektní rychlá svačina za hezkého počasí.',
    tip: 'Otevřeno za hezkého počasí. Hotová zmrzlina, žádné dlouhé čekání u stolu.',
    mapsQuery: 'Buburuza Eis Steyr Enge Gasse',
    hours: 'Ne 3.5.: 12–18 (závisí na počasí)',
    rating: { stars: 4.8, count: 1465, source: 'Google' },
  },
  {
    day: 3,
    kind: 'památka',
